...
const translations = {
  'zh-HK': {
    ...
    success: {
      ...
      waybillGenerating: '我哋會盡快為你安排出貨，物流資訊將顯示在「記錄」頁面。',
      verifyingPayment: '正在確認付款...',
      sfWaybill: '順豐單號',
      waybillLater: '物流單號將在出貨後顯示於「記錄」頁面。',
      retryManual: '重試確認',
      viewOrders: '查看我的訂單',
    ...
    admin: {
      ...
      aiAnalyzing: 'AI 正在分析實時數據...',
      aiDefault: '點擊按鈕獲取由 AI 提供的專業經營策略。',
    ...
    recipes: {
      ...
      video: '影片',
      tags: '標籤（逗號分隔）',
      tagsHint: '例如：15分鐘、快速晚餐、氣炸鍋',
      rawIngredients: '非賣品食材',
      ingredientName: '食材名稱',
      ingredientAmount: '份量',
      addIngredient: '新增食材',
      stepContent: '步驟內容',
      addStep: '新增步驟',
      selectProducts: '選擇關聯產品',
      searchProducts: '搜尋產品...',
      noProductsLinked: '未選擇關聯產品（可選）',
      save: '保存食譜',
      cancel: '取消',
      deleteRecipe: '刪除食譜',
      confirmDelete: '確定刪除此食譜嗎？此操作無法復原。',
      recipeSaved: '食譜已保存',
      recipeDeleted: '食譜已刪除',
      recipeSaveFailed: '食譜保存失敗',
      recipeDeleteFailed: '食譜刪除失敗',
      myProducts: '我的產品',
      otherIngredients: '其他食材',
      step: '步驟',
    },
    coupon: {
      myCoupons: '我的優惠券',
      pointsShop: '積分兌換',
      noCoupons: '暫時沒有優惠券',
      loginToView: '登入成為會員即可查看優惠券及積分兌換',
      loginNow: '立即登入',
      available: '可使用',
      used: '已使用',
      expired: '已過期',
      useNow: '立即使用',
      redeem: '兌換',
      redeemConfirm: '確定使用 {points} 積分兌換此優惠券？',
      redeemed: '兌換成功！',
      ...
      minSpend: '滿 ${min} 可用',
      expiresAt: '有效期至 {date}',
      pointsCost: '{points} 積分',
      couponApplied: '已套用優惠券',
      couponRemoved: '已移除優惠券',
      selectCoupon: '選擇優惠券',
      noCouponsAvailable: '沒有可用的優惠券',
      minSpendNotMet: '未達最低消費',
      oneCouponOnly: '每張訂單只能使用一張優惠券',
  ...
  en: {
    ...
    success: {
      ...
      waybillGenerating: 'We will arrange delivery soon. Tracking info will appear on the Orders page.',
      verifyingPayment: 'Confirming your payment...',
      sfWaybill: 'SF Tracking No.',
      waybillLater: 'Tracking number will appear on the Orders page after dispatch.',
      retryManual: 'Retry',
    ...
    admin: {
      ...
      aiAnalyzing: 'AI is analyzing real-time data...',
      aiDefault: 'Click to get professional business strategies powered by AI.',
    ...
    recipes: {
      ...
      tagsHint: 'e.g. 15-min, quick dinner, air fryer',
      rawIngredients: 'Other Ingredients',
      ingredientName: 'Ingredient',
      ingredientAmount: 'Amount',
      addIngredient: 'Add Ingredient',
      stepContent: 'Step content',
      addStep: 'Add Step',
      selectProducts: 'Link Products',
      searchProducts: 'Search products...',
      noProductsLinked: 'No products linked (optional)',
      save: 'Save Recipe',
      cancel: 'Cancel',
      deleteRecipe: 'Delete Recipe',
      confirmDelete: 'Are you sure you want to delete this recipe? This cannot be undone.',
      recipeSaved: 'Recipe saved',
      recipeDeleted: 'Recipe deleted',
      recipeSaveFailed: 'Recipe save failed',
      recipeDeleteFailed: 'Recipe delete failed',
      myProducts: 'Our Products',
    ...
    coupon: {
      ...
      loginToView: 'Login to view your coupons and redeem points',
      loginNow: 'Login Now',
      available: 'Available',
      used: 'Used',
      expired: 'Expired',
      useNow: 'Use Now',
      redeem: 'Redeem',
      redeemConfirm: 'Redeem this coupon for {points} points?',
      ...
      minSpendNotMet: 'Min. spend not met',
      oneCouponOnly: 'Only one coupon per order',
