...
10. **輸出**：嚴格JSON array，無markdown。無食品項→空array []`;
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const { message, products, clientNames, corrections, extraUnits } = req.body || {};
...
${productList}
${clientHint}${unitHint}${correctionHint}
...
JSON array:
[{"productId":"ID或null","productName":"中文名","originalText":"原文","qty":數字,"unit":"單位","note":"備註或null"}]`;
